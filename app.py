...
# -----------------------------------------------------------------------
# فرض اتجاه RTL على كامل الواجهة (Streamlit لا يدعم هذا افتراضياً للعناصر
# التفاعلية كالـ radio/multiselect/text_input، لذلك نفرضه عبر CSS عام)
# -----------------------------------------------------------------------
st.markdown(
    """
    <style>
...
# كل مسألة تحمل رأياً موحّداً بثلاث مستويات + (اختيارياً) تفصيل لكل مذهب.
# المسألة الأولى فقط موثّقة بتفصيل لكل مذهب حالياً كنموذج؛ الباقي تعرض
# رأياً عاماً موحداً إلى أن تُستكمل بقية المذاهب لاحقاً.
issues_data = [
    {
        "id": 1,
        "title": "صلاة الجماعة",
...
# مصطلحات رئيسية — كما طُلب بالضبط، مع دمج (المندوب) كمرادف لـ(المستحب) بدل تكراره
glossary_terms = [
...
# الأئمة المؤسسون — بالاسم الكامل، مكان الميلاد، مكان تأسيس المذهب، وفترة الحياة
imams_data = [
...
# -----------------------------------------------------------------------
# الترويسة (فقرة تعريفية موجزة كما طُلب)
# -----------------------------------------------------------------------
st.markdown(
    """
...
# -----------------------------------------------------------------------
# فقرات هامشية اختيارية (بدون تكرار لما سبق)
# -----------------------------------------------------------------------
